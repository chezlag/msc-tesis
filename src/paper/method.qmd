...
Siguiendo la notación de los autores, denoto por $G_{g}$ al grupo de firmas que comenzaron a recibir e-facturas en el período $g$; $t$ al tiempo y $e$ al tiempo-desde-el-evento. En otras palabras, $e = t-g$ señala el tiempo transcurrido desde el inicio del tratamiento. Mi primer parámetro de interés es
...
Por lo tanto, $\theta_{es}(e)$ es el efecto promedio de recibir e-facturas $e$ períodos después de iniciado el tratamiento, para todas las firmas que recibieron e-facturas por al menos $e$ períodos. Este parámetro es equivalente al parámetro de estudio de eventos, evitando las limitaciones señaladas. El supuesto de identificación central es que las firmas tratadas y el grupo de control habrían evolucionado en paralelo en ausencia de facturación electrónica. 
